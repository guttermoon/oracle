...
description: Use this skill to generate well-branded interfaces and assets for Starboard — a vision board & manifestation app. Contains colors, type, fonts, brand SVG/WebP assets, voice & tone, and UI kit components for the marketing site and the authenticated app. Use for production code or throwaway mocks, slides, and prototypes.
user-invocable: true
---
...
- `assets/elements/dark/` — 21 decorative WebP elements (anchor, compass, crow, key, lighthouse, …).
- `assets/decorations/` — sparkle stars, ornamental divider, moon frame.
- `assets/imagery/` — banner, OG image, icon backgrounds.
...
- `slides/` (if present) — title / quote / comparison slide templates.
...
## Brand guardrails — never violate
